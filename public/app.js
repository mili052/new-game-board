...
function rankingPlatform(product) {
  ...
  if (/微小|微信/.test(status)) return "微小";
  if (/抖小|抖音/.test(status)) return "抖小";
  if (/taptap/.test(status)) return "TapTap";
